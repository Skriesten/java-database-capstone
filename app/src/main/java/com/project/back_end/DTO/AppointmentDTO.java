...
public class AppointmentDTO {
    ...
    public AppointmentDTO(Long id, Long doctorId, String doctorName, Long patientId, String patientName, String patientEmail,
                          ...
                          LocalDateTime appointmentDate, LocalTime appointmentTimeOnly, LocalDateTime endTime) {
                                    ...
                                    this.status = status;
                                    this.appointmentDate = appointmentTime.toLocalDate().atStartOfDay();  // Calculate
                                    this.appointmentTimeOnly = appointmentTime.toLocalTime();  // based on appointmentTime field
                                    this.endTime = appointmentTime.plusHours(1);  // based on appointmentTime field
    }
